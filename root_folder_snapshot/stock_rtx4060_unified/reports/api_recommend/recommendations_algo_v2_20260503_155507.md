...
Generated: 2026-05-03T11:55:07+00:00
...
| 4 | AVGO | S | ELIGIBLE_RECOMMENDATION | 100.00 | 87.00% | 8.17 | 421.28 | 404.01 | 463.41 | 2.44 | 0.75% | 20.00% | 43.43 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 87.00%; 단기/중기 추세 확인 |
| 5 | GOOGL | S | ELIGIBLE_RECOMMENDATION | 100.00 | 63.26% | 4.86 | 385.69 | 370.26 | 424.26 | 2.50 | 0.75% | 20.00% | 48.61 | 9/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 63.26%; 단기/중기 추세 확인 |
...
- Model: prob=94.20%, acc=34.44%, auc=0.578, oof_coverage=75.00%
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=1564678515.88
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0186
- MODEL_EDGE: AMBER — prob=0.9420, acc=0.3444, auc=0.5778, models=logistic
- OOF_COVERAGE: PASS — coverage=75.00%, gap=20
...
- Model: prob=87.00%, acc=45.56%, auc=0.673, oof_coverage=75.00%
...
- MODEL_EDGE: AMBER — prob=0.8700, acc=0.4556, auc=0.6735, models=logistic
- OOF_COVERAGE: PASS — coverage=75.00%, gap=20
...
- Model: prob=63.26%, acc=55.28%, auc=0.712, oof_coverage=75.00%
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=9178084949.60
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0260
- MODEL_EDGE: PASS — prob=0.6326, acc=0.5528, auc=0.7119, models=logistic
- OOF_COVERAGE: PASS — coverage=75.00%, gap=20
