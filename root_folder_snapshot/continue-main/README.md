...
continue-main is the monorepo for the Continue open-source AI coding assistant. It provides context-aware code completion, chat, and automation within IDEs.

**Note: This project is NOT part of the stock trading system.** It is a general-purpose AI development tool.

## Tech Stack

| Layer | Technology | Purpose |
|-------|------------|---------|
| IDE Extensions | TypeScript | VS Code + JetBrains plugins |
| GUI | React | Web-based chat UI |
| Core | Node.js + TypeScript | Indexing, config, agents |
| Binary | Rust + C++ | High-performance autocomplete |
...
|---------|-------------|-------|
| stock_rtx4060_unified | NONE | Unrelated |
| stock-pred-v5 | NONE | Unrelated |

continue-main is a standalone AI development tool. No data flows to or from the stock trading projects.
