...
- **Test status must be rechecked in the current session before DONE.** Historical milestone: 2026-05-10 had 1,210 tests and 85.82% coverage; current CI gate is `fail_under=75` in `pyproject.toml`.
