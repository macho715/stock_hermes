...
Generated: 2026-05-02T20:59:24

Overall verdict: AMBER

Default `python` can compile and show help, but it lacks runtime dependencies. `run.ps1` and Python 3.12 execute the program successfully.
