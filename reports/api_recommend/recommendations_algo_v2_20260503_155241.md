...
Generated: 2026-05-03T11:52:41+00:00
...
| 3 | XLK | S | ELIGIBLE_RECOMMENDATION | 100.00 | 94.20% | 9.19 | 161.87 | 155.40 | 178.06 | 2.50 | 0.75% | 20.00% | 115.83 | 7/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 94.20%; 단기/중기 추세 확인 |
| 4 | AVGO | S | ELIGIBLE_RECOMMENDATION | 100.00 | 86.99% | 8.16 | 421.28 | 404.01 | 463.41 | 2.44 | 0.75% | 20.00% | 43.43 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 86.99%; 단기/중기 추세 확인 |
...
- Model: prob=94.20%, acc=34.72%, auc=0.578, oof_coverage=75.00%
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=1564678515.88
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0186
- MODEL_EDGE: AMBER — prob=0.9420, acc=0.3472, auc=0.5777, models=logistic
- OOF_COVERAGE: PASS — coverage=75.00%, gap=20
...
- Model: prob=86.99%, acc=45.56%, auc=0.673, oof_coverage=75.00%
...
- MODEL_EDGE: AMBER — prob=0.8699, acc=0.4556, auc=0.6735, models=logistic
- OOF_COVERAGE: PASS — coverage=75.00%, gap=20
