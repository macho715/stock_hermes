...
Generated: 2026-05-03T04:56:46+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | XLE | L | ACCUMULATE_RECOMMENDATION | 100.00 | 93.51% | 17.93 | 58.85 | 51.79 | 70.62 | 1.67 | 0.50% | 12.00% | 70.80 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
| 2 | QQQ | S | ELIGIBLE_RECOMMENDATION | 100.00 | 98.54% | 9.80 | 674.15 | 647.18 | 741.57 | 2.50 | 0.75% | 20.00% | 27.81 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 98.54%; 단기/중기 추세 확인 |
...
| 4 | AVGO | S | ELIGIBLE_RECOMMENDATION | 100.00 | 86.98% | 8.16 | 421.28 | 404.01 | 463.41 | 2.44 | 0.75% | 20.00% | 43.43 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 86.98%; 단기/중기 추세 확인 |
| 5 | GOOGL | S | ELIGIBLE_RECOMMENDATION | 100.00 | 63.18% | 4.85 | 385.69 | 370.26 | 424.26 | 2.50 | 0.75% | 20.00% | 48.61 | 9/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 63.18%; 단기/중기 추세 확인 |

## Validation details

### XLE / Track-L / ACCUMULATE_RECOMMENDATION
- Backtest: return=0.03%, Sharpe=0.048, Sortino=0.032, MDD=0.62%
- Model: prob=93.51%, acc=57.49%, auc=0.834, oof_coverage=74.83%
...
- MODEL_EDGE: PASS — prob=0.9351, acc=0.5749, auc=0.8335, models=logistic
...
- Model: prob=98.54%, acc=38.06%, auc=0.628, oof_coverage=75.00%
...
- MODEL_EDGE: AMBER — prob=0.9854, acc=0.3806, auc=0.6280, models=logistic
...
- Backtest: return=-2.51%, Sharpe=-0.718, Sortino=-0.584, MDD=3.18%
...
- MODEL_EDGE: AMBER — prob=0.9421, acc=0.3472, auc=0.5776, models=logistic
- OOF_COVERAGE: PASS — coverage=75.00%, gap=20
- BACKTEST_SANITY: AMBER — return=-2.51%, sharpe=-0.718, mdd=3.18%
- RISK_PLAN: PASS — stop_pct=4.00%, tp2_pct=10.00%, rr=2.50, risk_budget=0.75%
- TRACK_SCORE: PASS — score=100.00, green_threshold=75.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False
...
- Model: prob=86.98%, acc=45.56%, auc=0.673, oof_coverage=75.00%
...
- MODEL_EDGE: AMBER — prob=0.8698, acc=0.4556, auc=0.6735, models=logistic
- OOF_COVERAGE: PASS — coverage=75.00%, gap=20
...
- Model: prob=63.18%, acc=55.28%, auc=0.712, oof_coverage=75.00%
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=9178084949.60
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0260
- MODEL_EDGE: PASS — prob=0.6318, acc=0.5528, auc=0.7119, models=logistic
- OOF_COVERAGE: PASS — coverage=75.00%, gap=20
