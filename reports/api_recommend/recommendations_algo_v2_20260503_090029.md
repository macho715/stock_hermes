...
Generated: 2026-05-03T05:00:29+00:00
...
| 2 | QQQ | S | ELIGIBLE_RECOMMENDATION | 100.00 | 98.55% | 9.80 | 674.15 | 647.18 | 741.57 | 2.50 | 0.75% | 20.00% | 27.81 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 98.55%; 단기/중기 추세 확인 |
| 3 | XLK | S | ELIGIBLE_RECOMMENDATION | 100.00 | 94.22% | 9.19 | 161.87 | 155.40 | 178.06 | 2.50 | 0.75% | 20.00% | 115.83 | 7/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 94.22%; 단기/중기 추세 확인 |
| 4 | AVGO | S | ELIGIBLE_RECOMMENDATION | 100.00 | 87.03% | 8.17 | 421.28 | 404.01 | 463.41 | 2.44 | 0.75% | 20.00% | 43.43 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 87.03%; 단기/중기 추세 확인 |
| 5 | GOOGL | S | ELIGIBLE_RECOMMENDATION | 100.00 | 63.29% | 4.86 | 385.69 | 370.26 | 424.26 | 2.50 | 0.75% | 20.00% | 48.61 | 9/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 63.29%; 단기/중기 추세 확인 |
...
- Model: prob=98.55%, acc=38.06%, auc=0.628, oof_coverage=75.00%
...
- MODEL_EDGE: AMBER — prob=0.9855, acc=0.3806, auc=0.6281, models=logistic
...
- Model: prob=94.22%, acc=34.72%, auc=0.577, oof_coverage=75.00%
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=1564678515.88
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0186
- MODEL_EDGE: AMBER — prob=0.9422, acc=0.3472, auc=0.5774, models=logistic
- OOF_COVERAGE: PASS — coverage=75.00%, gap=20
...
- Model: prob=87.03%, acc=45.56%, auc=0.673, oof_coverage=75.00%
...
- MODEL_EDGE: AMBER — prob=0.8703, acc=0.4556, auc=0.6735, models=logistic
- OOF_COVERAGE: PASS — coverage=75.00%, gap=20
...
- Model: prob=63.29%, acc=55.28%, auc=0.712, oof_coverage=75.00%
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=9178084949.60
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0260
- MODEL_EDGE: PASS — prob=0.6329, acc=0.5528, auc=0.7119, models=logistic
- OOF_COVERAGE: PASS — coverage=75.00%, gap=20
