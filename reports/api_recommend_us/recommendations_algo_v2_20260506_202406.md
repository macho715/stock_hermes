...
Generated: 2026-05-06T16:24:06+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | GOOGL | S | ELIGIBLE_RECOMMENDATION | 100.00 | 87.39% | 8.23 | 398.98 | 383.02 | 438.88 | 2.50 | 0.75% | 20.00% | 46.99 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 87.39%; 단기/중기 추세 확인 |
| 2 | AAPL | S | ELIGIBLE_RECOMMENDATION | 100.00 | 83.89% | 7.74 | 285.79 | 274.36 | 314.37 | 2.50 | 0.75% | 20.00% | 65.61 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 83.89%; 단기/중기 추세 확인 |
| 3 | AMZN | L | ACCUMULATE_RECOMMENDATION | 99.91 | 77.31% | 12.74 | 275.60 | 242.53 | 330.72 | 1.67 | 0.50% | 12.00% | 15.12 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 장기 MDD 한도 내 |
| 4 | NVDA | L | ACCUMULATE_RECOMMENDATION | 99.08 | 96.02% | 18.73 | 205.15 | 180.53 | 246.18 | 1.67 | 0.50% | 12.00% | 20.31 | 8/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
| 5 | QQQ | S | ELIGIBLE_RECOMMENDATION | 98.47 | 92.90% | 9.01 | 692.20 | 664.51 | 761.42 | 2.50 | 0.75% | 20.00% | 27.09 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 92.90%; 단기/중기 추세 확인 |
...
- LIQUIDITY: PASS — avg_dollar_volume_20d=9298202052.75
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=12190723425.86
...
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=12878622251.77
...
- Risk plan: stop=12.00%, tp2=20.00%, R/R=1.67, position_value=4166.67
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=29047253139.24
...
- RISK_PLAN: PASS — stop_pct=12.00%, tp2_pct=20.00%, rr=1.67, risk_budget=0.50%
- TRACK_SCORE: PASS — score=99.08, green_threshold=80.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=25010508975.51
