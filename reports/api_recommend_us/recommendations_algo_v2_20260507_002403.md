...
Generated: 2026-05-06T20:24:03+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | QQQ | S | ELIGIBLE_RECOMMENDATION | 100.00 | 92.90% | 9.01 | 695.77 | 667.94 | 765.35 | 2.50 | 0.75% | 20.00% | 26.95 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 92.90%; 단기/중기 추세 확인 |
| 2 | GOOGL | S | ELIGIBLE_RECOMMENDATION | 100.00 | 87.39% | 8.23 | 398.04 | 382.12 | 437.84 | 2.50 | 0.75% | 20.00% | 47.11 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 87.39%; 단기/중기 추세 확인 |
| 3 | AAPL | S | ELIGIBLE_RECOMMENDATION | 100.00 | 83.89% | 7.74 | 287.51 | 276.01 | 316.26 | 2.50 | 0.75% | 20.00% | 65.22 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 83.89%; 단기/중기 추세 확인 |
| 4 | AMZN | L | ACCUMULATE_RECOMMENDATION | 99.83 | 77.31% | 12.74 | 274.99 | 241.99 | 329.99 | 1.67 | 0.50% | 12.00% | 15.15 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 장기 MDD 한도 내 |
| 5 | NVDA | L | ACCUMULATE_RECOMMENDATION | 99.72 | 96.02% | 18.73 | 207.83 | 182.89 | 249.40 | 1.67 | 0.50% | 12.00% | 20.05 | 8/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
...
- LIQUIDITY: PASS — avg_dollar_volume_20d=25606540269.35
...
- Model: prob=87.39%, acc=44.82%, auc=0.583, oof_coverage=74.53%
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=9620921064.83
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0250
- MODEL_EDGE: AMBER — prob=0.8739, acc=0.4482, auc=0.5832, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.53%, gap=20
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=12707373616.70
...
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=13192341470.06
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0266
...
- Risk plan: stop=12.00%, tp2=20.00%, R/R=1.67, position_value=4166.67
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=30004459154.83
