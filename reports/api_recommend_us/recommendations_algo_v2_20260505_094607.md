...
Generated: 2026-05-05T05:46:07+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | NVDA | L | ACCUMULATE_RECOMMENDATION | 100.00 | 77.45% | 12.78 | 198.48 | 174.66 | 238.18 | 1.67 | 0.50% | 12.00% | 20.99 | 7/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
| 2 | GOOGL | S | ELIGIBLE_RECOMMENDATION | 100.00 | 82.48% | 7.55 | 383.25 | 367.92 | 421.57 | 2.50 | 0.75% | 20.00% | 48.92 | 9/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 82.48%; 단기/중기 추세 확인 |
...
- Model: prob=77.45%, acc=44.44%, auc=0.737, oof_coverage=74.48%
...
- MODEL_EDGE: AMBER — prob=0.7745, acc=0.4444, auc=0.7372, models=logistic
...
- Model: prob=82.48%, acc=55.18%, auc=0.739, oof_coverage=74.69%
...
- MODEL_EDGE: PASS — prob=0.8248, acc=0.5518, auc=0.7385, models=logistic
