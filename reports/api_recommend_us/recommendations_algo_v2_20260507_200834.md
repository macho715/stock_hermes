...
Generated: 2026-05-07T16:08:34+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | AMZN | L | ACCUMULATE_RECOMMENDATION | 99.93 | 79.32% | 13.38 | 273.00 | 240.24 | 327.60 | 1.67 | 0.50% | 12.00% | 15.26 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 장기 MDD 한도 내 |
| 2 | AAPL | S | ELIGIBLE_RECOMMENDATION | 99.92 | 78.54% | 7.00 | 289.37 | 277.79 | 318.30 | 2.50 | 0.75% | 20.00% | 64.80 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 78.54%; 단기/중기 추세 확인 |
| 3 | QQQ | L | ACCUMULATE_RECOMMENDATION | 96.65 | 93.10% | 17.79 | 696.07 | 612.54 | 835.29 | 1.67 | 0.50% | 12.00% | 5.99 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 장기 MDD 한도 내 |
| 4 | SPY | S | ELIGIBLE_RECOMMENDATION | 96.43 | 96.03% | 9.44 | 733.03 | 703.71 | 806.34 | 2.50 | 0.75% | 20.00% | 25.58 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 96.03%; 단기/중기 추세 확인 |
| 5 | MSFT | S | ELIGIBLE_RECOMMENDATION | 95.97 | 96.06% | 9.45 | 424.39 | 407.42 | 466.83 | 2.50 | 0.75% | 20.00% | 44.18 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 96.06%; 단기/중기 추세 확인 |
...
- LIQUIDITY: PASS — avg_dollar_volume_20d=12657114930.11
...
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=12622067700.34
...
- Risk plan: stop=12.00%, tp2=20.00%, R/R=1.67, position_value=4166.67
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=25112147392.66
...
- RISK_PLAN: PASS — stop_pct=12.00%, tp2_pct=20.00%, rr=1.67, risk_budget=0.50%
- TRACK_SCORE: PASS — score=96.65, green_threshold=80.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=34514414666.60
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=14306887115.92
