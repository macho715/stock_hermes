...
Generated: 2026-05-06T15:31:28+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | NVDA | L | ACCUMULATE_RECOMMENDATION | 100.00 | 92.97% | 17.75 | 206.63 | 181.83 | 247.96 | 1.67 | 0.50% | 12.00% | 20.16 | 8/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
| 2 | QQQ | S | ELIGIBLE_RECOMMENDATION | 100.00 | 99.86% | 9.98 | 692.29 | 664.60 | 761.52 | 2.50 | 0.75% | 20.00% | 27.08 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 99.86%; 단기/중기 추세 확인 |
| 3 | SPY | S | ELIGIBLE_RECOMMENDATION | 100.00 | 99.79% | 9.97 | 732.07 | 702.79 | 805.28 | 2.50 | 0.75% | 20.00% | 25.61 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 99.79%; 단기/중기 추세 확인 |
| 4 | GOOGL | S | ELIGIBLE_RECOMMENDATION | 99.66 | 69.24% | 5.69 | 395.66 | 379.83 | 435.23 | 2.50 | 0.75% | 20.00% | 47.39 | 9/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 69.24%; 단기/중기 추세 확인 |
| 5 | AMZN | S | ELIGIBLE_RECOMMENDATION | 96.69 | 99.52% | 9.93 | 273.56 | 262.62 | 300.92 | 2.50 | 0.75% | 20.00% | 68.54 | 9/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 99.52%; 단기/중기 추세 확인 |
...
- Model: prob=92.97%, acc=44.95%, auc=0.737, oof_coverage=75.00%
- Risk plan: stop=12.00%, tp2=20.00%, R/R=1.67, position_value=4166.67
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=28905398253.22
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0313
- MODEL_EDGE: AMBER — prob=0.9297, acc=0.4495, auc=0.7366, models=logistic
...
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=24909153161.30
...
- Backtest honesty: AMBER (pass=4, amber=1, fail=0)
- Model: prob=99.79%, acc=35.57%, auc=0.634, oof_coverage=74.53%
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=34393974732.80
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0106
- MODEL_EDGE: AMBER — prob=0.9979, acc=0.3557, auc=0.6340, models=logistic
- OOF_COVERAGE: PASS — coverage=74.53%, gap=20
...
- Model: prob=69.24%, acc=53.78%, auc=0.740, oof_coverage=74.53%
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=9249744845.63
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0249
- MODEL_EDGE: PASS — prob=0.6924, acc=0.5378, auc=0.7402, models=logistic
- OOF_COVERAGE: PASS — coverage=74.53%, gap=20
- BACKTEST_SANITY: PASS — return=1.71%, sharpe=0.747, mdd=1.21%
- RISK_PLAN: PASS — stop_pct=4.00%, tp2_pct=10.00%, rr=2.50, risk_budget=0.75%
- TRACK_SCORE: PASS — score=99.66, green_threshold=75.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=12817576317.18
