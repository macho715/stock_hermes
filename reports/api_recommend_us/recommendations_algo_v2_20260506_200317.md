...
Generated: 2026-05-06T16:03:17+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | NVDA | L | ACCUMULATE_RECOMMENDATION | 100.00 | 93.04% | 17.77 | 205.09 | 180.47 | 246.10 | 1.67 | 0.50% | 12.00% | 20.32 | 8/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
| 2 | QQQ | S | ELIGIBLE_RECOMMENDATION | 100.00 | 99.86% | 9.98 | 692.24 | 664.55 | 761.46 | 2.50 | 0.75% | 20.00% | 27.09 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 99.86%; 단기/중기 추세 확인 |
| 3 | SPY | S | ELIGIBLE_RECOMMENDATION | 100.00 | 99.80% | 9.97 | 731.87 | 702.59 | 805.05 | 2.50 | 0.75% | 20.00% | 25.62 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 99.80%; 단기/중기 추세 확인 |
| 4 | GOOGL | S | ELIGIBLE_RECOMMENDATION | 100.00 | 69.25% | 5.70 | 397.88 | 381.97 | 437.67 | 2.50 | 0.75% | 20.00% | 47.12 | 9/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 69.25%; 단기/중기 추세 확인 |
| 5 | AMZN | S | ELIGIBLE_RECOMMENDATION | 96.69 | 99.52% | 9.93 | 274.85 | 263.85 | 302.33 | 2.50 | 0.75% | 20.00% | 68.22 | 9/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 99.52%; 단기/중기 추세 확인 |
...
- Model: prob=93.04%, acc=44.95%, auc=0.736, oof_coverage=75.00%
- Risk plan: stop=12.00%, tp2=20.00%, R/R=1.67, position_value=4166.67
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=29001717193.09
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0317
- MODEL_EDGE: AMBER — prob=0.9304, acc=0.4495, auc=0.7364, models=logistic
...
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=24968774195.30
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=34467614340.36
...
- Model: prob=69.25%, acc=53.78%, auc=0.740, oof_coverage=74.53%
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=9274567835.75
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0247
- MODEL_EDGE: PASS — prob=0.6925, acc=0.5378, auc=0.7399, models=logistic
- OOF_COVERAGE: PASS — coverage=74.53%, gap=20
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=12861340526.06
