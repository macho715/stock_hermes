...
Generated: 2026-05-07T16:21:38+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | AAPL | S | ELIGIBLE_RECOMMENDATION | 99.92 | 78.54% | 7.00 | 289.38 | 277.80 | 318.32 | 2.50 | 0.75% | 20.00% | 64.79 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 78.54%; 단기/중기 추세 확인 |
| 2 | AMZN | L | ACCUMULATE_RECOMMENDATION | 99.88 | 79.32% | 13.38 | 271.50 | 238.92 | 325.80 | 1.67 | 0.50% | 12.00% | 15.35 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 장기 MDD 한도 내 |
| 3 | QQQ | L | ACCUMULATE_RECOMMENDATION | 96.48 | 93.10% | 17.79 | 694.18 | 610.88 | 833.02 | 1.67 | 0.50% | 12.00% | 6.00 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 장기 MDD 한도 내 |
| 4 | MSFT | S | ELIGIBLE_RECOMMENDATION | 95.62 | 95.74% | 9.40 | 423.44 | 406.50 | 465.78 | 2.50 | 0.75% | 20.00% | 44.28 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 95.74%; 단기/중기 추세 확인 |
| 5 | AAPL | L | ACCUMULATE_RECOMMENDATION | 95.08 | 71.46% | 10.87 | 289.38 | 254.65 | 347.26 | 1.67 | 0.50% | 12.00% | 14.40 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 장기 MDD 한도 내 |
...
- LIQUIDITY: PASS — avg_dollar_volume_20d=12633704650.12
...
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=12670917123.11
...
- Risk plan: stop=12.00%, tp2=20.00%, R/R=1.67, position_value=4166.67
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=25171425400.47
...
- RISK_PLAN: PASS — stop_pct=12.00%, tp2_pct=20.00%, rr=1.67, risk_budget=0.50%
- TRACK_SCORE: PASS — score=96.48, green_threshold=80.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=14319055329.88
...
- RISK_PLAN: PASS — stop_pct=12.00%, tp2_pct=20.00%, rr=1.67, risk_budget=0.50%
- TRACK_SCORE: PASS — score=95.08, green_threshold=80.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False
