...
Generated: 2026-05-07T16:08:51+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | AMZN | L | ACCUMULATE_RECOMMENDATION | 99.93 | 79.32% | 13.38 | 273.05 | 240.28 | 327.66 | 1.67 | 0.50% | 12.00% | 15.26 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 장기 MDD 한도 내 |
| 2 | AAPL | S | ELIGIBLE_RECOMMENDATION | 99.92 | 78.54% | 7.00 | 289.34 | 277.77 | 318.27 | 2.50 | 0.75% | 20.00% | 64.80 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 78.54%; 단기/중기 추세 확인 |
| 3 | QQQ | L | ACCUMULATE_RECOMMENDATION | 96.66 | 93.10% | 17.79 | 696.19 | 612.65 | 835.43 | 1.67 | 0.50% | 12.00% | 5.99 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 장기 MDD 한도 내 |
| 4 | SPY | S | ELIGIBLE_RECOMMENDATION | 96.43 | 96.03% | 9.44 | 733.26 | 703.93 | 806.59 | 2.50 | 0.75% | 20.00% | 25.57 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 96.03%; 단기/중기 추세 확인 |
| 5 | MSFT | S | ELIGIBLE_RECOMMENDATION | 95.97 | 96.06% | 9.45 | 424.34 | 407.37 | 466.77 | 2.50 | 0.75% | 20.00% | 44.19 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 96.06%; 단기/중기 추세 확인 |
...
- LIQUIDITY: PASS — avg_dollar_volume_20d=12657252680.60
...
- TRACK_SCORE: PASS — score=99.93, green_threshold=80.00
...
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=12622234705.63
...
- Risk plan: stop=12.00%, tp2=20.00%, R/R=1.67, position_value=4166.67
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=25113154738.91
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0140
- MODEL_EDGE: PASS — prob=0.9310, acc=0.5138, auc=0.4862, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.83%, gap=63
- BACKTEST_SANITY: PASS — return=0.91%, sharpe=0.701, mdd=1.06%
- RISK_PLAN: PASS — stop_pct=12.00%, tp2_pct=20.00%, rr=1.67, risk_budget=0.50%
- TRACK_SCORE: PASS — score=96.66, green_threshold=80.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=34515327240.64
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0103
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=14307144343.97
