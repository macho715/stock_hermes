...
Generated: 2026-05-06T16:35:33+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | GOOGL | S | ELIGIBLE_RECOMMENDATION | 100.00 | 87.39% | 8.23 | 399.38 | 383.40 | 439.31 | 2.50 | 0.75% | 20.00% | 46.95 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 87.39%; 단기/중기 추세 확인 |
| 2 | AAPL | S | ELIGIBLE_RECOMMENDATION | 100.00 | 83.89% | 7.74 | 285.87 | 274.44 | 314.46 | 2.50 | 0.75% | 20.00% | 65.59 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 83.89%; 단기/중기 추세 확인 |
| 3 | AMZN | L | ACCUMULATE_RECOMMENDATION | 99.91 | 77.31% | 12.74 | 275.83 | 242.73 | 331.00 | 1.67 | 0.50% | 12.00% | 15.11 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 장기 MDD 한도 내 |
| 4 | NVDA | L | ACCUMULATE_RECOMMENDATION | 99.14 | 96.02% | 18.73 | 205.38 | 180.73 | 246.46 | 1.67 | 0.50% | 12.00% | 20.29 | 8/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
| 5 | QQQ | S | ELIGIBLE_RECOMMENDATION | 98.47 | 92.90% | 9.01 | 692.09 | 664.41 | 761.30 | 2.50 | 0.75% | 20.00% | 27.09 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 92.90%; 단기/중기 추세 확인 |
...
- LIQUIDITY: PASS — avg_dollar_volume_20d=9307700355.25
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0249
- MODEL_EDGE: AMBER — prob=0.8739, acc=0.4510, auc=0.5811, models=xgb-cpu
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=12202953263.71
...
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=12888183550.80
...
- Risk plan: stop=12.00%, tp2=20.00%, R/R=1.67, position_value=4166.67
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=29068951947.01
...
- RISK_PLAN: PASS — stop_pct=12.00%, tp2_pct=20.00%, rr=1.67, risk_budget=0.50%
- TRACK_SCORE: PASS — score=99.14, green_threshold=80.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=25021766943.94
