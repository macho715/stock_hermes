...
Generated: 2026-05-06T15:59:51+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | NVDA | L | ACCUMULATE_RECOMMENDATION | 100.00 | 93.05% | 17.77 | 204.79 | 180.22 | 245.75 | 1.67 | 0.50% | 12.00% | 20.35 | 8/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
| 2 | QQQ | S | ELIGIBLE_RECOMMENDATION | 100.00 | 99.86% | 9.98 | 691.95 | 664.27 | 761.14 | 2.50 | 0.75% | 20.00% | 27.10 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 99.86%; 단기/중기 추세 확인 |
| 3 | SPY | S | ELIGIBLE_RECOMMENDATION | 100.00 | 99.80% | 9.97 | 731.67 | 702.40 | 804.84 | 2.50 | 0.75% | 20.00% | 25.63 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 99.80%; 단기/중기 추세 확인 |
| 4 | GOOGL | S | ELIGIBLE_RECOMMENDATION | 100.00 | 69.30% | 5.70 | 397.48 | 381.58 | 437.23 | 2.50 | 0.75% | 20.00% | 47.17 | 9/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 69.30%; 단기/중기 추세 확인 |
...
- LIQUIDITY: PASS — avg_dollar_volume_20d=28992737085.49
...
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=24963445813.40
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=34461475971.61
...
- Model: prob=69.30%, acc=53.78%, auc=0.740, oof_coverage=74.53%
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=9271437547.36
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0248
- MODEL_EDGE: PASS — prob=0.6930, acc=0.5378, auc=0.7402, models=logistic
- OOF_COVERAGE: PASS — coverage=74.53%, gap=20
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=12858081390.23
