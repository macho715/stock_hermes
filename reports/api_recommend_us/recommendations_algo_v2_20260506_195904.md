...
Generated: 2026-05-06T15:59:04+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | NVDA | L | ACCUMULATE_RECOMMENDATION | 100.00 | 93.05% | 17.78 | 204.78 | 180.20 | 245.73 | 1.67 | 0.50% | 12.00% | 20.35 | 8/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
| 2 | QQQ | S | ELIGIBLE_RECOMMENDATION | 100.00 | 99.86% | 9.98 | 691.91 | 664.24 | 761.11 | 2.50 | 0.75% | 20.00% | 27.10 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 99.86%; 단기/중기 추세 확인 |
| 3 | SPY | S | ELIGIBLE_RECOMMENDATION | 100.00 | 99.79% | 9.97 | 731.73 | 702.46 | 804.90 | 2.50 | 0.75% | 20.00% | 25.62 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 99.79%; 단기/중기 추세 확인 |
| 4 | GOOGL | S | ELIGIBLE_RECOMMENDATION | 100.00 | 69.18% | 5.69 | 397.36 | 381.47 | 437.10 | 2.50 | 0.75% | 20.00% | 47.19 | 9/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 69.18%; 단기/중기 추세 확인 |
| 5 | AMZN | S | ELIGIBLE_RECOMMENDATION | 96.69 | 99.52% | 9.93 | 274.81 | 263.81 | 302.29 | 2.50 | 0.75% | 20.00% | 68.23 | 9/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 99.52%; 단기/중기 추세 확인 |
...
- Model: prob=93.05%, acc=44.95%, auc=0.736, oof_coverage=75.00%
- Risk plan: stop=12.00%, tp2=20.00%, R/R=1.67, position_value=4166.67
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=28991385323.18
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0317
- MODEL_EDGE: AMBER — prob=0.9305, acc=0.4495, auc=0.7364, models=logistic
...
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=24963080276.10
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=34460662257.71
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0106
- MODEL_EDGE: AMBER — prob=0.9979, acc=0.3557, auc=0.6341, models=logistic
- OOF_COVERAGE: PASS — coverage=74.53%, gap=20
...
- Model: prob=69.18%, acc=53.78%, auc=0.740, oof_coverage=74.53%
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=9270896958.05
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0248
- MODEL_EDGE: PASS — prob=0.6918, acc=0.5378, auc=0.7403, models=logistic
- OOF_COVERAGE: PASS — coverage=74.53%, gap=20
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=12856919127.44
