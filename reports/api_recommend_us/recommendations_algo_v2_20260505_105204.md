...
Generated: 2026-05-05T06:52:04+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | NVDA | L | ACCUMULATE_RECOMMENDATION | 100.00 | 77.57% | 12.82 | 198.48 | 174.66 | 238.18 | 1.67 | 0.50% | 12.00% | 20.99 | 7/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
...
- Model: prob=77.57%, acc=44.44%, auc=0.737, oof_coverage=74.48%
...
- MODEL_EDGE: AMBER — prob=0.7757, acc=0.4444, auc=0.7371, models=logistic
