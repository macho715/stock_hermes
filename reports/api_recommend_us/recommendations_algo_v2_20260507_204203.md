...
Generated: 2026-05-07T16:42:03+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | AAPL | S | ELIGIBLE_RECOMMENDATION | 99.92 | 78.54% | 7.00 | 289.56 | 277.98 | 318.52 | 2.50 | 0.75% | 20.00% | 64.75 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 78.54%; 단기/중기 추세 확인 |
| 2 | AMZN | L | ACCUMULATE_RECOMMENDATION | 99.90 | 79.32% | 13.38 | 272.68 | 239.96 | 327.22 | 1.67 | 0.50% | 12.00% | 15.28 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 장기 MDD 한도 내 |
| 3 | QQQ | L | ACCUMULATE_RECOMMENDATION | 96.64 | 93.10% | 17.79 | 696.28 | 612.73 | 835.54 | 1.67 | 0.50% | 12.00% | 5.98 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 장기 MDD 한도 내 |
| 4 | SPY | S | ELIGIBLE_RECOMMENDATION | 96.43 | 96.03% | 9.44 | 733.13 | 703.80 | 806.44 | 2.50 | 0.75% | 20.00% | 25.58 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 96.03%; 단기/중기 추세 확인 |
| 5 | MSFT | S | ELIGIBLE_RECOMMENDATION | 95.62 | 95.74% | 9.40 | 423.45 | 406.52 | 465.80 | 2.50 | 0.75% | 20.00% | 44.28 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 95.74%; 단기/중기 추세 확인 |
...
- LIQUIDITY: PASS — avg_dollar_volume_20d=12650124902.32
...
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=12693672397.76
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0262
...
- TRACK_SCORE: PASS — score=99.90, green_threshold=80.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False
...
- Risk plan: stop=12.00%, tp2=20.00%, R/R=1.67, position_value=4166.67
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=25236503609.20
...
- RISK_PLAN: PASS — stop_pct=12.00%, tp2_pct=20.00%, rr=1.67, risk_budget=0.50%
- TRACK_SCORE: PASS — score=96.64, green_threshold=80.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=34649012351.66
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0104
...
- Backtest: return=0.49%, Sharpe=0.209, Sortino=0.176, MDD=1.31%
- Backtest honesty: AMBER (pass=4, amber=1, fail=0)
- Model: prob=95.74%, acc=47.78%, auc=0.692, oof_coverage=75.00%
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=14334208637.86
- MARKET_REGIME: PASS — regime_score=65.00, atr_pct=0.0266
- MODEL_EDGE: AMBER — prob=0.9574, acc=0.4778, auc=0.6915, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=75.00%, gap=20
- BACKTEST_SANITY: PASS — return=0.49%, sharpe=0.209, mdd=1.31%
- RISK_PLAN: PASS — stop_pct=4.00%, tp2_pct=10.00%, rr=2.50, risk_budget=0.75%
- TRACK_SCORE: PASS — score=95.62, green_threshold=75.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False
