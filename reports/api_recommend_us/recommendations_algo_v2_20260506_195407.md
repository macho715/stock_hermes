...
Generated: 2026-05-06T15:54:07+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | NVDA | L | ACCUMULATE_RECOMMENDATION | 100.00 | 93.07% | 17.78 | 204.73 | 180.16 | 245.67 | 1.67 | 0.50% | 12.00% | 20.35 | 8/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
| 2 | QQQ | S | ELIGIBLE_RECOMMENDATION | 100.00 | 99.86% | 9.98 | 692.01 | 664.33 | 761.21 | 2.50 | 0.75% | 20.00% | 27.09 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 99.86%; 단기/중기 추세 확인 |
...
| 4 | GOOGL | S | ELIGIBLE_RECOMMENDATION | 100.00 | 69.25% | 5.70 | 397.53 | 381.63 | 437.28 | 2.50 | 0.75% | 20.00% | 47.17 | 9/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 69.25%; 단기/중기 추세 확인 |
| 5 | AMZN | S | ELIGIBLE_RECOMMENDATION | 96.69 | 99.52% | 9.93 | 274.45 | 263.48 | 301.90 | 2.50 | 0.75% | 20.00% | 68.32 | 9/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 99.52%; 단기/중기 추세 확인 |
...
- LIQUIDITY: PASS — avg_dollar_volume_20d=28979463065.74
...
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=24956715389.92
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=34451883359.78
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=9267347838.25
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0248
- MODEL_EDGE: PASS — prob=0.6925, acc=0.5378, auc=0.7403, models=logistic
- OOF_COVERAGE: PASS — coverage=74.53%, gap=20
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=752, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=12848936958.52
