...
Generated: 2026-05-06T03:09:05+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | NVDA | L | ACCUMULATE_RECOMMENDATION | 100.00 | 82.33% | 14.35 | 196.50 | 172.92 | 235.80 | 1.67 | 0.50% | 12.00% | 21.20 | 8/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
...
| 3 | SPY | S | ELIGIBLE_RECOMMENDATION | 100.00 | 99.53% | 9.93 | 723.77 | 694.82 | 796.15 | 2.50 | 0.75% | 20.00% | 25.91 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 99.53%; 단기/중기 추세 확인 |
...
| 5 | AAPL | S | ELIGIBLE_RECOMMENDATION | 95.92 | 64.91% | 5.09 | 284.18 | 272.81 | 312.60 | 2.50 | 0.75% | 20.00% | 65.98 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 64.91%; 단기/중기 추세 확인 |
...
- Model: prob=82.33%, acc=39.20%, auc=0.737, oof_coverage=74.48%
...
- MODEL_EDGE: AMBER — prob=0.8233, acc=0.3920, auc=0.7372, models=logistic
...
- Model: prob=99.55%, acc=41.18%, auc=0.615, oof_coverage=74.69%
...
- MODEL_EDGE: AMBER — prob=0.9955, acc=0.4118, auc=0.6146, models=logistic
...
- Backtest honesty: AMBER (pass=4, amber=1, fail=0)
- Model: prob=99.53%, acc=35.85%, auc=0.625, oof_coverage=74.69%
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=751, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=36831245453.50
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0106
- MODEL_EDGE: AMBER — prob=0.9953, acc=0.3585, auc=0.6248, models=logistic
- OOF_COVERAGE: PASS — coverage=74.69%, gap=20
...
- MODEL_EDGE: PASS — prob=0.7989, acc=0.5462, auc=0.7399, models=logistic
- OOF_COVERAGE: PASS — coverage=74.69%, gap=20
...
- Backtest honesty: AMBER (pass=3, amber=2, fail=0)
- Model: prob=64.91%, acc=57.14%, auc=0.717, oof_coverage=74.69%
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=751, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=12380671500.59
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0234
- MODEL_EDGE: PASS — prob=0.6491, acc=0.5714, auc=0.7171, models=logistic
- OOF_COVERAGE: PASS — coverage=74.69%, gap=20
- BACKTEST_SANITY: AMBER — return=-1.36%, sharpe=-0.478, mdd=3.33%
- RISK_PLAN: PASS — stop_pct=4.00%, tp2_pct=10.00%, rr=2.50, risk_budget=0.75%
- TRACK_SCORE: PASS — score=95.92, green_threshold=75.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False
