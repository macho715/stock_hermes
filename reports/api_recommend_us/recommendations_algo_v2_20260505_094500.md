...
Generated: 2026-05-05T05:45:00+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | NVDA | L | ACCUMULATE_RECOMMENDATION | 100.00 | 77.58% | 12.83 | 198.48 | 174.66 | 238.18 | 1.67 | 0.50% | 12.00% | 20.99 | 7/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
| 2 | GOOGL | S | ELIGIBLE_RECOMMENDATION | 100.00 | 82.41% | 7.54 | 383.25 | 367.92 | 421.57 | 2.50 | 0.75% | 20.00% | 48.92 | 9/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 82.41%; 단기/중기 추세 확인 |
...
| 5 | QQQ | S | ELIGIBLE_RECOMMENDATION | 96.63 | 99.38% | 9.91 | 672.88 | 645.96 | 740.17 | 2.50 | 0.75% | 20.00% | 27.87 | 7/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 99.38%; 단기/중기 추세 확인 |
...
- Model: prob=77.58%, acc=44.44%, auc=0.737, oof_coverage=74.48%
...
- MODEL_EDGE: AMBER — prob=0.7758, acc=0.4444, auc=0.7371, models=logistic
...
- Model: prob=82.41%, acc=55.18%, auc=0.739, oof_coverage=74.69%
...
- MODEL_EDGE: PASS — prob=0.8241, acc=0.5518, auc=0.7385, models=logistic
...
- MODEL_EDGE: AMBER — prob=0.9984, acc=0.3585, auc=0.6130, models=logistic
- OOF_COVERAGE: PASS — coverage=74.69%, gap=20
...
- MODEL_EDGE: AMBER — prob=0.9938, acc=0.4118, auc=0.6060, models=logistic
- OOF_COVERAGE: PASS — coverage=74.69%, gap=20
