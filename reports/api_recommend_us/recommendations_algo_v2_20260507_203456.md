...
Generated: 2026-05-07T16:34:56+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | AAPL | S | ELIGIBLE_RECOMMENDATION | 99.92 | 78.54% | 7.00 | 289.12 | 277.56 | 318.03 | 2.50 | 0.75% | 20.00% | 64.85 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 78.54%; 단기/중기 추세 확인 |
...
| 3 | QQQ | L | ACCUMULATE_RECOMMENDATION | 96.64 | 93.10% | 17.79 | 696.89 | 613.27 | 836.27 | 1.67 | 0.50% | 12.00% | 5.98 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 장기 MDD 한도 내 |
| 4 | SPY | S | ELIGIBLE_RECOMMENDATION | 96.43 | 96.03% | 9.44 | 733.62 | 704.28 | 806.99 | 2.50 | 0.75% | 20.00% | 25.56 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 96.03%; 단기/중기 추세 확인 |
| 5 | MSFT | S | ELIGIBLE_RECOMMENDATION | 95.97 | 96.06% | 9.45 | 424.62 | 407.63 | 467.08 | 2.50 | 0.75% | 20.00% | 44.16 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 96.06%; 단기/중기 추세 확인 |
...
- LIQUIDITY: PASS — avg_dollar_volume_20d=12645602176.38
...
- Risk plan: stop=12.00%, tp2=20.00%, R/R=1.67, position_value=4166.67
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=25216672214.90
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=34630059956.76
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=14330634689.78
