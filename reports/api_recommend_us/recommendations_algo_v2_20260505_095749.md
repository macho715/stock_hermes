...
Generated: 2026-05-05T05:57:49+00:00
...
| 2 | GOOGL | S | ELIGIBLE_RECOMMENDATION | 100.00 | 82.47% | 7.54 | 383.25 | 367.92 | 421.57 | 2.50 | 0.75% | 20.00% | 48.92 | 9/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 82.47%; 단기/중기 추세 확인 |
...
- Model: prob=82.47%, acc=55.18%, auc=0.738, oof_coverage=74.69%
...
- MODEL_EDGE: PASS — prob=0.8247, acc=0.5518, auc=0.7382, models=logistic
...
- MODEL_EDGE: AMBER — prob=0.9939, acc=0.4118, auc=0.6055, models=logistic
- OOF_COVERAGE: PASS — coverage=74.69%, gap=20
