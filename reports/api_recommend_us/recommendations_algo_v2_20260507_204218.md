...
Generated: 2026-05-07T16:42:18+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | AAPL | S | ELIGIBLE_RECOMMENDATION | 99.92 | 78.54% | 7.00 | 289.50 | 277.92 | 318.46 | 2.50 | 0.75% | 20.00% | 64.77 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 78.54%; 단기/중기 추세 확인 |
| 2 | AMZN | L | ACCUMULATE_RECOMMENDATION | 99.90 | 79.32% | 13.38 | 272.75 | 240.02 | 327.30 | 1.67 | 0.50% | 12.00% | 15.28 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 장기 MDD 한도 내 |
| 3 | QQQ | L | ACCUMULATE_RECOMMENDATION | 96.64 | 93.10% | 17.79 | 696.25 | 612.70 | 835.50 | 1.67 | 0.50% | 12.00% | 5.98 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 장기 MDD 한도 내 |
| 4 | SPY | S | ELIGIBLE_RECOMMENDATION | 96.43 | 96.03% | 9.44 | 733.08 | 703.76 | 806.39 | 2.50 | 0.75% | 20.00% | 25.58 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 96.03%; 단기/중기 추세 확인 |
| 5 | MSFT | S | ELIGIBLE_RECOMMENDATION | 95.62 | 95.74% | 9.40 | 423.43 | 406.49 | 465.77 | 2.50 | 0.75% | 20.00% | 44.28 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 95.74%; 단기/중기 추세 확인 |
...
- LIQUIDITY: PASS — avg_dollar_volume_20d=12650211948.05
...
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=12693825972.01
...
- Risk plan: stop=12.00%, tp2=20.00%, R/R=1.67, position_value=4166.67
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=25236723123.60
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=34649699288.45
...
- Risk plan: stop=4.00%, tp2=10.00%, R/R=2.50, position_value=18750.00
- DATA_ROWS: PASS — rows=753, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=14334356452.85
