...
Generated: 2026-05-05T05:48:38+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | NVDA | L | ACCUMULATE_RECOMMENDATION | 100.00 | 77.55% | 12.81 | 198.48 | 174.66 | 238.18 | 1.67 | 0.50% | 12.00% | 20.99 | 7/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
...
- MODEL_EDGE: AMBER — prob=0.7755, acc=0.4444, auc=0.7372, models=logistic
...
- Model: prob=82.41%, acc=55.18%, auc=0.738, oof_coverage=74.69%
...
- MODEL_EDGE: PASS — prob=0.8241, acc=0.5518, auc=0.7382, models=logistic
...
- MODEL_EDGE: AMBER — prob=0.9984, acc=0.3585, auc=0.6131, models=logistic
- OOF_COVERAGE: PASS — coverage=74.69%, gap=20
...
- MODEL_EDGE: AMBER — prob=0.9939, acc=0.4118, auc=0.6059, models=logistic
- OOF_COVERAGE: PASS — coverage=74.69%, gap=20
