...
Generated: 2026-05-06T16:03:30+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | 005380.KS | L | ACCUMULATE_RECOMMENDATION | 100.00 | 86.51% | 15.68 | 539000.00 | 474320.00 | 646800.00 | 1.67 | 0.50% | 12.00% | 0.01 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
...
| 3 | 005490.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 93.74% | 9.06 | 502000.00 | 476900.00 | 552200.00 | 2.00 | 0.75% | 20.00% | 0.03 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 93.74%; 단기/중기 추세 확인 |
| 4 | 000660.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 83.51% | 7.53 | 1447000.00 | 1374650.00 | 1591700.00 | 2.00 | 0.75% | 20.00% | 0.01 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 83.51%; 단기/중기 추세 확인 |
...
- Backtest: return=1.22%, Sharpe=0.667, Sortino=0.891, MDD=0.88%
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=86.51%, acc=60.46%, auc=0.658, oof_coverage=74.45%
...
- MODEL_EDGE: PASS — prob=0.8651, acc=0.6046, auc=0.6584, models=logistic
- OOF_COVERAGE: PASS — coverage=74.45%, gap=63
- BACKTEST_SANITY: PASS — return=1.22%, sharpe=0.667, mdd=0.88%
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=100.00%, acc=48.38%, auc=0.646, oof_coverage=74.67%
...
- MODEL_EDGE: AMBER — prob=1.0000, acc=0.4838, auc=0.6456, models=logistic
...
- Backtest: return=0.75%, Sharpe=0.208, Sortino=0.154, MDD=3.25%
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=93.74%, acc=45.72%, auc=0.688, oof_coverage=74.67%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=727, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=224680495525.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0396
- MODEL_EDGE: AMBER — prob=0.9374, acc=0.4572, auc=0.6877, models=logistic
- OOF_COVERAGE: PASS — coverage=74.67%, gap=20
- BACKTEST_SANITY: PASS — return=0.75%, sharpe=0.208, mdd=3.25%
- RISK_PLAN: PASS — stop_pct=5.00%, tp2_pct=10.00%, rr=2.00, risk_budget=0.75%
- TRACK_SCORE: PASS — score=100.00, green_threshold=75.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=83.51%, acc=48.08%, auc=0.822, oof_coverage=74.83%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=727, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=4515674580800.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0447
- MODEL_EDGE: AMBER — prob=0.8351, acc=0.4808, auc=0.8215, models=logistic
...
- Backtest: return=0.56%, Sharpe=0.358, Sortino=0.320, MDD=1.65%
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=99.99%, acc=48.04%, auc=0.756, oof_coverage=74.45%
- Risk plan: stop=12.00%, tp2=20.00%, R/R=1.67, position_value=4166.67
- DATA_ROWS: PASS — rows=727, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=224680495525.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0396
- MODEL_EDGE: AMBER — prob=0.9999, acc=0.4804, auc=0.7559, models=logistic
- OOF_COVERAGE: PASS — coverage=74.45%, gap=63
- BACKTEST_SANITY: PASS — return=0.56%, sharpe=0.358, mdd=1.65%
- RISK_PLAN: PASS — stop_pct=12.00%, tp2_pct=20.00%, rr=1.67, risk_budget=0.50%
