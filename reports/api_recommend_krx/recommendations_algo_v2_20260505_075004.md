...
Generated: 2026-05-05T03:50:04+00:00
...
| 4 | 005380.KS | L | ACCUMULATE_RECOMMENDATION | 99.72 | 86.72% | 15.75 | 539000.00 | 474320.00 | 646800.00 | 1.67 | 0.50% | 12.00% | 0.01 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
...
- Model: prob=100.00%, acc=48.38%, auc=0.645, oof_coverage=74.51%
...
- MODEL_EDGE: AMBER — prob=1.0000, acc=0.4838, auc=0.6449, models=logistic
...
- MODEL_EDGE: AMBER — prob=0.8331, acc=0.4779, auc=0.8204, models=logistic
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=86.72%, acc=59.55%, auc=0.515, oof_coverage=75.00%
...
- MODEL_EDGE: PASS — prob=0.8672, acc=0.5955, auc=0.5150, models=logistic
