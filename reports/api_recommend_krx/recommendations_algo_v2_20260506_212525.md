...
Generated: 2026-05-06T17:25:25+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | 005930.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 96.64% | 9.50 | 232500.00 | 220875.00 | 255750.00 | 2.00 | 0.75% | 20.00% | 0.06 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 96.64%; 단기/중기 추세 확인 |
...
| 4 | 005380.KS | L | ACCUMULATE_RECOMMENDATION | 99.55 | 90.78% | 17.05 | 539000.00 | 474320.00 | 646800.00 | 1.67 | 0.50% | 12.00% | 0.01 | 8/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
...
- Model: prob=96.64%, acc=34.22%, auc=0.585, oof_coverage=74.67%
...
- MODEL_EDGE: AMBER — prob=0.9664, acc=0.3422, auc=0.5853, models=xgb-cpu
...
- MODEL_EDGE: AMBER — prob=0.9630, acc=0.4602, auc=0.7624, models=xgb-cpu
...
- MODEL_EDGE: AMBER — prob=0.8768, acc=0.4071, auc=0.6716, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.67%, gap=20
...
- Model: prob=90.78%, acc=24.84%, auc=0.472, oof_coverage=74.45%
...
- MODEL_EDGE: AMBER — prob=0.9078, acc=0.2484, auc=0.4717, models=xgb-cpu
