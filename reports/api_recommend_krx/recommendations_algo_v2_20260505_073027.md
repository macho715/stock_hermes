...
Generated: 2026-05-05T03:30:27+00:00
...
| 4 | 005380.KS | L | ACCUMULATE_RECOMMENDATION | 99.88 | 86.83% | 15.78 | 539000.00 | 474320.00 | 646800.00 | 1.67 | 0.50% | 12.00% | 0.01 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
...
- Backtest: return=1.27%, Sharpe=0.388, Sortino=0.346, MDD=2.09%
...
- BACKTEST_SANITY: PASS — return=1.27%, sharpe=0.388, mdd=2.09%
...
- MODEL_EDGE: AMBER — prob=0.8342, acc=0.4779, auc=0.8207, models=logistic
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=86.83%, acc=59.87%, auc=0.521, oof_coverage=75.00%
...
- MODEL_EDGE: PASS — prob=0.8683, acc=0.5987, auc=0.5214, models=logistic
