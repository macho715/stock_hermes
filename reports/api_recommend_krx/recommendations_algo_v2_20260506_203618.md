...
Generated: 2026-05-06T16:36:18+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | 005930.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 97.05% | 9.56 | 232500.00 | 220875.00 | 255750.00 | 2.00 | 0.75% | 20.00% | 0.06 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 97.05%; 단기/중기 추세 확인 |
| 2 | 000660.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 96.30% | 9.45 | 1447000.00 | 1374650.00 | 1591700.00 | 2.00 | 0.75% | 20.00% | 0.01 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 96.30%; 단기/중기 추세 확인 |
| 3 | 005490.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 87.00% | 8.05 | 502000.00 | 476900.00 | 552200.00 | 2.00 | 0.75% | 20.00% | 0.03 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 87.00%; 단기/중기 추세 확인 |
| 4 | 005380.KS | L | ACCUMULATE_RECOMMENDATION | 99.55 | 90.81% | 17.06 | 539000.00 | 474320.00 | 646800.00 | 1.67 | 0.50% | 12.00% | 0.01 | 8/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
...
- Model: prob=97.05%, acc=34.51%, auc=0.590, oof_coverage=74.67%
...
- MODEL_EDGE: AMBER — prob=0.9705, acc=0.3451, auc=0.5898, models=xgb-cpu
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=96.30%, acc=46.02%, auc=0.761, oof_coverage=74.83%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=727, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=4515674580800.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0447
- MODEL_EDGE: AMBER — prob=0.9630, acc=0.4602, auc=0.7610, models=xgb-cpu
...
- Backtest: return=-0.17%, Sharpe=-0.031, Sortino=-0.022, MDD=3.18%
- Backtest honesty: AMBER (pass=4, amber=1, fail=0)
- Model: prob=87.00%, acc=40.41%, auc=0.674, oof_coverage=74.67%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=727, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=224680495525.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0396
- MODEL_EDGE: AMBER — prob=0.8700, acc=0.4041, auc=0.6737, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.67%, gap=20
- BACKTEST_SANITY: PASS — return=-0.17%, sharpe=-0.031, mdd=3.18%
- RISK_PLAN: PASS — stop_pct=5.00%, tp2_pct=10.00%, rr=2.00, risk_budget=0.75%
- TRACK_SCORE: PASS — score=100.00, green_threshold=75.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False
...
- Backtest honesty: AMBER (pass=4, amber=1, fail=0)
- Model: prob=90.81%, acc=24.84%, auc=0.462, oof_coverage=74.45%
...
- MODEL_EDGE: AMBER — prob=0.9081, acc=0.2484, auc=0.4617, models=xgb-cpu
