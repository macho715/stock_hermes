...
Generated: 2026-05-06T16:03:04+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | 005380.KS | L | ACCUMULATE_RECOMMENDATION | 100.00 | 86.84% | 15.79 | 539000.00 | 474320.00 | 646800.00 | 1.67 | 0.50% | 12.00% | 0.01 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
| 2 | 005930.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 100.00% | 10.00 | 232500.00 | 220875.00 | 255750.00 | 2.00 | 0.75% | 20.00% | 0.06 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 100.00%; 단기/중기 추세 확인 |
| 3 | 005490.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 93.32% | 9.00 | 502000.00 | 476900.00 | 552200.00 | 2.00 | 0.75% | 20.00% | 0.03 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 93.32%; 단기/중기 추세 확인 |
| 4 | 000660.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 83.43% | 7.51 | 1447000.00 | 1374650.00 | 1591700.00 | 2.00 | 0.75% | 20.00% | 0.01 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 83.43%; 단기/중기 추세 확인 |
...
- Backtest: return=1.21%, Sharpe=0.638, Sortino=0.861, MDD=0.96%
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=86.84%, acc=60.46%, auc=0.657, oof_coverage=74.45%
...
- MODEL_EDGE: PASS — prob=0.8684, acc=0.6046, auc=0.6568, models=logistic
- OOF_COVERAGE: PASS — coverage=74.45%, gap=63
- BACKTEST_SANITY: PASS — return=1.21%, sharpe=0.638, mdd=0.96%
...
- Backtest: return=0.86%, Sharpe=0.278, Sortino=0.247, MDD=2.09%
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=100.00%, acc=48.67%, auc=0.644, oof_coverage=74.67%
...
- MODEL_EDGE: AMBER — prob=1.0000, acc=0.4867, auc=0.6440, models=logistic
- OOF_COVERAGE: PASS — coverage=74.67%, gap=20
- BACKTEST_SANITY: PASS — return=0.86%, sharpe=0.278, mdd=2.09%
...
- Backtest: return=0.66%, Sharpe=0.184, Sortino=0.136, MDD=3.25%
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=93.32%, acc=46.31%, auc=0.687, oof_coverage=74.67%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=727, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=224680495525.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0396
- MODEL_EDGE: AMBER — prob=0.9332, acc=0.4631, auc=0.6869, models=logistic
- OOF_COVERAGE: PASS — coverage=74.67%, gap=20
- BACKTEST_SANITY: PASS — return=0.66%, sharpe=0.184, mdd=3.25%
- RISK_PLAN: PASS — stop_pct=5.00%, tp2_pct=10.00%, rr=2.00, risk_budget=0.75%
- TRACK_SCORE: PASS — score=100.00, green_threshold=75.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False

### 000660.KS / Track-S / ELIGIBLE_RECOMMENDATION
- Backtest: return=2.40%, Sharpe=0.687, Sortino=0.574, MDD=2.33%
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=83.43%, acc=48.08%, auc=0.822, oof_coverage=74.83%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=727, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=4515674580800.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0447
- MODEL_EDGE: AMBER — prob=0.8343, acc=0.4808, auc=0.8217, models=logistic
- OOF_COVERAGE: PASS — coverage=74.83%, gap=20
- BACKTEST_SANITY: PASS — return=2.40%, sharpe=0.687, mdd=2.33%
- RISK_PLAN: PASS — stop_pct=5.00%, tp2_pct=10.00%, rr=2.00, risk_budget=0.75%
- TRACK_SCORE: PASS — score=100.00, green_threshold=75.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False

### 005490.KS / Track-L / ACCUMULATE_RECOMMENDATION
- Backtest: return=0.62%, Sharpe=0.379, Sortino=0.356, MDD=1.65%
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=99.99%, acc=49.02%, auc=0.755, oof_coverage=74.45%
- Risk plan: stop=12.00%, tp2=20.00%, R/R=1.67, position_value=4166.67
- DATA_ROWS: PASS — rows=727, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=224680495525.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0396
- MODEL_EDGE: AMBER — prob=0.9999, acc=0.4902, auc=0.7549, models=logistic
- OOF_COVERAGE: PASS — coverage=74.45%, gap=63
- BACKTEST_SANITY: PASS — return=0.62%, sharpe=0.379, mdd=1.65%
- RISK_PLAN: PASS — stop_pct=12.00%, tp2_pct=20.00%, rr=1.67, risk_budget=0.50%
