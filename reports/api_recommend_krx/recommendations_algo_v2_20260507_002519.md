...
Generated: 2026-05-06T20:25:19+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | 000660.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 95.94% | 9.39 | 1601000.00 | 1520950.00 | 1761100.00 | 2.00 | 0.75% | 20.00% | 0.01 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 95.94%; 단기/중기 추세 확인 |
| 2 | 005490.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 86.92% | 8.04 | 506000.00 | 480700.00 | 556600.00 | 2.00 | 0.75% | 20.00% | 0.03 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 86.92%; 단기/중기 추세 확인 |
| 3 | 005930.KS | S | ELIGIBLE_RECOMMENDATION | 99.87 | 96.50% | 9.47 | 266000.00 | 252700.00 | 292600.00 | 2.00 | 0.75% | 20.00% | 0.06 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 96.50%; 단기/중기 추세 확인 |
...
| 5 | 005380.KS | S | ELIGIBLE_RECOMMENDATION | 99.53 | 90.02% | 8.50 | 550000.00 | 522500.00 | 605000.00 | 2.00 | 0.75% | 20.00% | 0.03 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 90.02%; 단기/중기 추세 확인 |
...
- Model: prob=95.94%, acc=46.61%, auc=0.733, oof_coverage=74.67%
...
- MODEL_EDGE: AMBER — prob=0.9594, acc=0.4661, auc=0.7334, models=xgb-cpu
...
- Backtest: return=0.55%, Sharpe=0.151, Sortino=0.114, MDD=2.72%
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=86.92%, acc=39.82%, auc=0.681, oof_coverage=74.51%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=728, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=235337044575.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0395
- MODEL_EDGE: AMBER — prob=0.8692, acc=0.3982, auc=0.6810, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.51%, gap=20
- BACKTEST_SANITY: PASS — return=0.55%, sharpe=0.151, mdd=2.72%
- RISK_PLAN: PASS — stop_pct=5.00%, tp2_pct=10.00%, rr=2.00, risk_budget=0.75%
- TRACK_SCORE: PASS — score=100.00, green_threshold=75.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False

### 005930.KS / Track-S / ELIGIBLE_RECOMMENDATION
- Backtest: return=1.26%, Sharpe=0.620, Sortino=0.469, MDD=0.91%
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=96.50%, acc=33.33%, auc=0.595, oof_coverage=74.51%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=728, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=5602731199675.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0421
- MODEL_EDGE: AMBER — prob=0.9650, acc=0.3333, auc=0.5946, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.51%, gap=20
- BACKTEST_SANITY: PASS — return=1.26%, sharpe=0.620, mdd=0.91%
- RISK_PLAN: PASS — stop_pct=5.00%, tp2_pct=10.00%, rr=2.00, risk_budget=0.75%
...
- Backtest: return=2.15%, Sharpe=0.638, Sortino=0.733, MDD=1.43%
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=90.02%, acc=37.76%, auc=0.587, oof_coverage=74.51%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=728, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=562002585075.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0464
- MODEL_EDGE: AMBER — prob=0.9002, acc=0.3776, auc=0.5865, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.51%, gap=20
- BACKTEST_SANITY: PASS — return=2.15%, sharpe=0.638, mdd=1.43%
- RISK_PLAN: PASS — stop_pct=5.00%, tp2_pct=10.00%, rr=2.00, risk_budget=0.75%
- TRACK_SCORE: PASS — score=99.53, green_threshold=75.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False
