...
Generated: 2026-05-06T16:37:35+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | 005930.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 96.87% | 9.53 | 232500.00 | 220875.00 | 255750.00 | 2.00 | 0.75% | 20.00% | 0.06 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 96.87%; 단기/중기 추세 확인 |
| 2 | 000660.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 96.17% | 9.43 | 1447000.00 | 1374650.00 | 1591700.00 | 2.00 | 0.75% | 20.00% | 0.01 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 96.17%; 단기/중기 추세 확인 |
| 3 | 005490.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 87.70% | 8.15 | 502000.00 | 476900.00 | 552200.00 | 2.00 | 0.75% | 20.00% | 0.03 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 87.70%; 단기/중기 추세 확인 |
...
| 5 | 005490.KS | L | ACCUMULATE_RECOMMENDATION | 97.86 | 94.30% | 18.18 | 502000.00 | 441760.00 | 602400.00 | 1.67 | 0.50% | 12.00% | 0.01 | 7/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 장기 MDD 한도 내 |
...
- Model: prob=96.87%, acc=34.22%, auc=0.597, oof_coverage=74.67%
...
- MODEL_EDGE: AMBER — prob=0.9687, acc=0.3422, auc=0.5974, models=xgb-cpu
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=96.17%, acc=46.02%, auc=0.762, oof_coverage=74.83%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=727, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=4515674580800.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0447
- MODEL_EDGE: AMBER — prob=0.9617, acc=0.4602, auc=0.7618, models=xgb-cpu
...
- Model: prob=87.70%, acc=40.12%, auc=0.674, oof_coverage=74.67%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=727, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=224680495525.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0396
- MODEL_EDGE: AMBER — prob=0.8770, acc=0.4012, auc=0.6737, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.67%, gap=20
...
- Backtest honesty: AMBER (pass=4, amber=1, fail=0)
- Model: prob=90.81%, acc=24.84%, auc=0.482, oof_coverage=74.45%
...
- MODEL_EDGE: AMBER — prob=0.9081, acc=0.2484, auc=0.4817, models=xgb-cpu
...
- Model: prob=94.30%, acc=32.68%, auc=0.723, oof_coverage=74.45%
- Risk plan: stop=12.00%, tp2=20.00%, R/R=1.67, position_value=4166.67
- DATA_ROWS: PASS — rows=727, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=224680495525.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0396
- MODEL_EDGE: AMBER — prob=0.9430, acc=0.3268, auc=0.7226, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.45%, gap=63
