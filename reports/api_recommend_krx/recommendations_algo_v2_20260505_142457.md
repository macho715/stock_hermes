...
Generated: 2026-05-05T10:24:57+00:00
...
| 2 | 005490.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 90.77% | 8.62 | 502000.00 | 476900.00 | 552200.00 | 2.00 | 0.75% | 20.00% | 0.03 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 90.77%; 단기/중기 추세 확인 |
...
| 4 | 005380.KS | L | ACCUMULATE_RECOMMENDATION | 99.88 | 86.78% | 15.77 | 539000.00 | 474320.00 | 646800.00 | 1.67 | 0.50% | 12.00% | 0.01 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
...
- Model: prob=100.00%, acc=49.26%, auc=0.646, oof_coverage=74.51%
...
- MODEL_EDGE: AMBER — prob=1.0000, acc=0.4926, auc=0.6456, models=logistic
...
- Model: prob=90.77%, acc=45.72%, auc=0.685, oof_coverage=74.51%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=728, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=224680495525.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0396
- MODEL_EDGE: AMBER — prob=0.9077, acc=0.4572, auc=0.6846, models=logistic
- OOF_COVERAGE: PASS — coverage=74.51%, gap=20
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=83.45%, acc=48.08%, auc=0.822, oof_coverage=74.67%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=728, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=4515674580800.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0447
- MODEL_EDGE: AMBER — prob=0.8345, acc=0.4808, auc=0.8223, models=logistic
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=86.78%, acc=59.87%, auc=0.521, oof_coverage=75.00%
...
- MODEL_EDGE: PASS — prob=0.8678, acc=0.5987, auc=0.5214, models=logistic
