...
Generated: 2026-05-06T16:37:31+00:00
...
| 3 | 005490.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 87.97% | 8.20 | 502000.00 | 476900.00 | 552200.00 | 2.00 | 0.75% | 20.00% | 0.03 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 87.97%; 단기/중기 추세 확인 |
| 4 | 005380.KS | L | ACCUMULATE_RECOMMENDATION | 99.55 | 90.77% | 17.05 | 539000.00 | 474320.00 | 646800.00 | 1.67 | 0.50% | 12.00% | 0.01 | 8/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
...
- Model: prob=96.73%, acc=34.51%, auc=0.592, oof_coverage=74.67%
...
- MODEL_EDGE: AMBER — prob=0.9673, acc=0.3451, auc=0.5917, models=xgb-cpu
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=96.30%, acc=46.02%, auc=0.762, oof_coverage=74.83%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=727, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=4515674580800.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0447
- MODEL_EDGE: AMBER — prob=0.9630, acc=0.4602, auc=0.7618, models=xgb-cpu
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=87.97%, acc=40.41%, auc=0.665, oof_coverage=74.67%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=727, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=224680495525.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0396
- MODEL_EDGE: AMBER — prob=0.8797, acc=0.4041, auc=0.6647, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.67%, gap=20
...
- Model: prob=90.77%, acc=24.84%, auc=0.472, oof_coverage=74.45%
...
- MODEL_EDGE: AMBER — prob=0.9077, acc=0.2484, auc=0.4717, models=xgb-cpu
...
- LIQUIDITY: PASS — avg_dollar_volume_20d=224680495525.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0396
- MODEL_EDGE: AMBER — prob=0.9430, acc=0.3268, auc=0.7232, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.45%, gap=63
