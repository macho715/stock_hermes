...
Generated: 2026-05-05T05:52:36+00:00
...
| 2 | 005490.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 91.65% | 8.75 | 502000.00 | 476900.00 | 552200.00 | 2.00 | 0.75% | 20.00% | 0.03 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 91.65%; 단기/중기 추세 확인 |
...
| 4 | 005380.KS | L | ACCUMULATE_RECOMMENDATION | 99.82 | 87.11% | 15.87 | 539000.00 | 474320.00 | 646800.00 | 1.67 | 0.50% | 12.00% | 0.01 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
...
- Model: prob=100.00%, acc=48.67%, auc=0.647, oof_coverage=74.51%
...
- MODEL_EDGE: AMBER — prob=1.0000, acc=0.4867, auc=0.6470, models=logistic
...
- Model: prob=91.65%, acc=45.72%, auc=0.684, oof_coverage=74.51%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=728, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=224680495525.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0396
- MODEL_EDGE: AMBER — prob=0.9165, acc=0.4572, auc=0.6842, models=logistic
- OOF_COVERAGE: PASS — coverage=74.51%, gap=20
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=83.38%, acc=47.79%, auc=0.821, oof_coverage=74.67%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=728, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=4515674580800.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0447
- MODEL_EDGE: AMBER — prob=0.8338, acc=0.4779, auc=0.8209, models=logistic
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=87.11%, acc=59.22%, auc=0.518, oof_coverage=75.00%
...
- MODEL_EDGE: PASS — prob=0.8711, acc=0.5922, auc=0.5184, models=logistic
