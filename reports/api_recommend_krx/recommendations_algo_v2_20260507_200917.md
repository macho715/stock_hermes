...
Generated: 2026-05-07T16:09:17+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | 000660.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 96.04% | 9.41 | 1601000.00 | 1520950.00 | 1761100.00 | 2.00 | 0.75% | 20.00% | 0.01 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 96.04%; 단기/중기 추세 확인 |
| 2 | 005490.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 87.02% | 8.05 | 506000.00 | 480700.00 | 556600.00 | 2.00 | 0.75% | 20.00% | 0.03 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 87.02%; 단기/중기 추세 확인 |
...
| 4 | 005930.KS | S | ELIGIBLE_RECOMMENDATION | 99.61 | 96.86% | 9.53 | 266000.00 | 252700.00 | 292600.00 | 2.00 | 0.75% | 20.00% | 0.06 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 96.86%; 단기/중기 추세 확인 |
| 5 | 005380.KS | L | ACCUMULATE_RECOMMENDATION | 99.32 | 92.25% | 17.52 | 550000.00 | 484000.00 | 660000.00 | 1.67 | 0.50% | 12.00% | 0.01 | 8/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
...
- Model: prob=96.04%, acc=46.31%, auc=0.740, oof_coverage=74.67%
...
- MODEL_EDGE: AMBER — prob=0.9604, acc=0.4631, auc=0.7400, models=xgb-cpu
...
- Backtest: return=1.02%, Sharpe=0.268, Sortino=0.203, MDD=2.72%
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=87.02%, acc=40.71%, auc=0.678, oof_coverage=74.51%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=728, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=235337044575.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0395
- MODEL_EDGE: AMBER — prob=0.8702, acc=0.4071, auc=0.6778, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.51%, gap=20
- BACKTEST_SANITY: PASS — return=1.02%, sharpe=0.268, mdd=2.72%
- RISK_PLAN: PASS — stop_pct=5.00%, tp2_pct=10.00%, rr=2.00, risk_budget=0.75%
- TRACK_SCORE: PASS — score=100.00, green_threshold=75.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False
...
- Backtest: return=1.19%, Sharpe=0.587, Sortino=0.450, MDD=0.96%
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=96.86%, acc=33.63%, auc=0.592, oof_coverage=74.51%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=728, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=5602731199675.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0421
- MODEL_EDGE: AMBER — prob=0.9686, acc=0.3363, auc=0.5916, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.51%, gap=20
- BACKTEST_SANITY: PASS — return=1.19%, sharpe=0.587, mdd=0.96%
- RISK_PLAN: PASS — stop_pct=5.00%, tp2_pct=10.00%, rr=2.00, risk_budget=0.75%
- TRACK_SCORE: PASS — score=99.61, green_threshold=75.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False

### 005380.KS / Track-L / ACCUMULATE_RECOMMENDATION
- Backtest: return=0.00%, Sharpe=0.000, Sortino=0.000, MDD=0.00%
- Backtest honesty: AMBER (pass=4, amber=1, fail=0)
- Model: prob=92.25%, acc=25.24%, auc=0.478, oof_coverage=75.00%
- Risk plan: stop=12.00%, tp2=20.00%, R/R=1.67, position_value=4166.67
- DATA_ROWS: PASS — rows=728, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=562002585075.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0464
- MODEL_EDGE: AMBER — prob=0.9225, acc=0.2524, auc=0.4785, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=75.00%, gap=63
- BACKTEST_SANITY: PASS — return=0.00%, sharpe=0.000, mdd=0.00%
- RISK_PLAN: PASS — stop_pct=12.00%, tp2_pct=20.00%, rr=1.67, risk_budget=0.50%
