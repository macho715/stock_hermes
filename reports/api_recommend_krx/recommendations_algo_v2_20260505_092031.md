...
Generated: 2026-05-05T05:20:31+00:00
...
| 2 | 005490.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 90.97% | 8.64 | 502000.00 | 476900.00 | 552200.00 | 2.00 | 0.75% | 20.00% | 0.03 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 90.97%; 단기/중기 추세 확인 |
...
| 4 | 005380.KS | L | ACCUMULATE_RECOMMENDATION | 99.72 | 86.94% | 15.82 | 539000.00 | 474320.00 | 646800.00 | 1.67 | 0.50% | 12.00% | 0.01 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
...
- Model: prob=100.00%, acc=48.08%, auc=0.646, oof_coverage=74.51%
...
- MODEL_EDGE: AMBER — prob=1.0000, acc=0.4808, auc=0.6459, models=logistic
...
- MODEL_EDGE: AMBER — prob=0.8340, acc=0.4779, auc=0.8212, models=logistic
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=86.94%, acc=59.55%, auc=0.515, oof_coverage=75.00%
...
- MODEL_EDGE: PASS — prob=0.8694, acc=0.5955, auc=0.5150, models=logistic
