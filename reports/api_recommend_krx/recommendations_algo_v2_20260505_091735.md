...
Generated: 2026-05-05T05:17:35+00:00
...
| 4 | 005380.KS | L | ACCUMULATE_RECOMMENDATION | 99.88 | 86.63% | 15.72 | 539000.00 | 474320.00 | 646800.00 | 1.67 | 0.50% | 12.00% | 0.01 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
...
- MODEL_EDGE: AMBER — prob=1.0000, acc=0.4867, auc=0.6439, models=logistic
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=83.49%, acc=47.79%, auc=0.821, oof_coverage=74.67%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=728, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=4515674580800.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0447
- MODEL_EDGE: AMBER — prob=0.8349, acc=0.4779, auc=0.8207, models=logistic
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=86.63%, acc=59.87%, auc=0.521, oof_coverage=75.00%
...
- MODEL_EDGE: PASS — prob=0.8663, acc=0.5987, auc=0.5214, models=logistic
