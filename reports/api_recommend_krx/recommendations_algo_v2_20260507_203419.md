...
Generated: 2026-05-07T16:34:19+00:00
...
| 2 | 005490.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 86.38% | 7.96 | 506000.00 | 480700.00 | 556600.00 | 2.00 | 0.75% | 20.00% | 0.03 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 86.38%; 단기/중기 추세 확인 |
| 3 | 005380.KS | S | ELIGIBLE_RECOMMENDATION | 99.91 | 90.12% | 8.52 | 550000.00 | 522500.00 | 605000.00 | 2.00 | 0.75% | 20.00% | 0.03 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 90.12%; 단기/중기 추세 확인 |
...
| 5 | 005930.KS | S | ELIGIBLE_RECOMMENDATION | 99.48 | 96.98% | 9.55 | 266000.00 | 252700.00 | 292600.00 | 2.00 | 0.75% | 20.00% | 0.06 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 96.98%; 단기/중기 추세 확인 |
...
- Model: prob=96.04%, acc=46.61%, auc=0.733, oof_coverage=74.67%
...
- MODEL_EDGE: AMBER — prob=0.9604, acc=0.4661, auc=0.7334, models=xgb-cpu
...
- Backtest: return=0.59%, Sharpe=0.160, Sortino=0.120, MDD=2.72%
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=86.38%, acc=40.12%, auc=0.683, oof_coverage=74.51%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=728, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=235337044575.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0395
- MODEL_EDGE: AMBER — prob=0.8638, acc=0.4012, auc=0.6826, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.51%, gap=20
- BACKTEST_SANITY: PASS — return=0.59%, sharpe=0.160, mdd=2.72%
- RISK_PLAN: PASS — stop_pct=5.00%, tp2_pct=10.00%, rr=2.00, risk_budget=0.75%
- TRACK_SCORE: PASS — score=100.00, green_threshold=75.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=90.12%, acc=37.46%, auc=0.591, oof_coverage=74.51%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=728, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=562002585075.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0464
- MODEL_EDGE: AMBER — prob=0.9012, acc=0.3746, auc=0.5905, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.51%, gap=20
- BACKTEST_SANITY: PASS — return=2.46%, sharpe=0.692, mdd=1.43%
- RISK_PLAN: PASS — stop_pct=5.00%, tp2_pct=10.00%, rr=2.00, risk_budget=0.75%
- TRACK_SCORE: PASS — score=99.91, green_threshold=75.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False
...
- Backtest: return=1.12%, Sharpe=0.555, Sortino=0.424, MDD=0.96%
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=96.98%, acc=33.04%, auc=0.592, oof_coverage=74.51%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=728, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=5602731199675.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0421
- MODEL_EDGE: AMBER — prob=0.9698, acc=0.3304, auc=0.5915, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.51%, gap=20
- BACKTEST_SANITY: PASS — return=1.12%, sharpe=0.555, mdd=0.96%
- RISK_PLAN: PASS — stop_pct=5.00%, tp2_pct=10.00%, rr=2.00, risk_budget=0.75%
