...
Generated: 2026-05-06T16:35:43+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | 005930.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 96.85% | 9.53 | 232500.00 | 220875.00 | 255750.00 | 2.00 | 0.75% | 20.00% | 0.06 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 96.85%; 단기/중기 추세 확인 |
...
| 3 | 005490.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 88.52% | 8.28 | 502000.00 | 476900.00 | 552200.00 | 2.00 | 0.75% | 20.00% | 0.03 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 88.52%; 단기/중기 추세 확인 |
| 4 | 005380.KS | L | ACCUMULATE_RECOMMENDATION | 99.55 | 90.95% | 17.10 | 539000.00 | 474320.00 | 646800.00 | 1.67 | 0.50% | 12.00% | 0.01 | 8/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
...
- Backtest: return=1.27%, Sharpe=0.619, Sortino=0.484, MDD=0.96%
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=96.85%, acc=34.22%, auc=0.577, oof_coverage=74.67%
...
- MODEL_EDGE: AMBER — prob=0.9685, acc=0.3422, auc=0.5769, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.67%, gap=20
- BACKTEST_SANITY: PASS — return=1.27%, sharpe=0.619, mdd=0.96%
...
- MODEL_EDGE: AMBER — prob=0.9606, acc=0.4602, auc=0.7612, models=xgb-cpu
...
- Model: prob=88.52%, acc=40.71%, auc=0.679, oof_coverage=74.67%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=727, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=224680495525.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0396
- MODEL_EDGE: AMBER — prob=0.8852, acc=0.4071, auc=0.6790, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.67%, gap=20
...
- Backtest honesty: AMBER (pass=4, amber=1, fail=0)
- Model: prob=90.95%, acc=24.84%, auc=0.477, oof_coverage=74.45%
...
- MODEL_EDGE: AMBER — prob=0.9095, acc=0.2484, auc=0.4767, models=xgb-cpu
