...
Generated: 2026-05-06T16:37:18+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | 005930.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 96.73% | 9.51 | 232500.00 | 220875.00 | 255750.00 | 2.00 | 0.75% | 20.00% | 0.06 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 96.73%; 단기/중기 추세 확인 |
...
| 3 | 005490.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 87.68% | 8.15 | 502000.00 | 476900.00 | 552200.00 | 2.00 | 0.75% | 20.00% | 0.03 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 87.68%; 단기/중기 추세 확인 |
...
- Model: prob=96.73%, acc=33.92%, auc=0.607, oof_coverage=74.67%
...
- MODEL_EDGE: AMBER — prob=0.9673, acc=0.3392, auc=0.6065, models=xgb-cpu
...
- MODEL_EDGE: AMBER — prob=0.9630, acc=0.4602, auc=0.7612, models=xgb-cpu
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=87.68%, acc=40.71%, auc=0.672, oof_coverage=74.67%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=727, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=224680495525.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0396
- MODEL_EDGE: AMBER — prob=0.8768, acc=0.4071, auc=0.6725, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.67%, gap=20
...
- Model: prob=90.81%, acc=24.84%, auc=0.478, oof_coverage=74.45%
...
- MODEL_EDGE: AMBER — prob=0.9081, acc=0.2484, auc=0.4783, models=xgb-cpu
...
- LIQUIDITY: PASS — avg_dollar_volume_20d=224680495525.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0396
- MODEL_EDGE: AMBER — prob=0.9410, acc=0.3268, auc=0.7232, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.45%, gap=63
