...
Generated: 2026-05-06T17:25:20+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | 005930.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 96.99% | 9.55 | 232500.00 | 220875.00 | 255750.00 | 2.00 | 0.75% | 20.00% | 0.06 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 96.99%; 단기/중기 추세 확인 |
...
| 3 | 005490.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 88.55% | 8.28 | 502000.00 | 476900.00 | 552200.00 | 2.00 | 0.75% | 20.00% | 0.03 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 88.55%; 단기/중기 추세 확인 |
...
- Model: prob=96.99%, acc=33.63%, auc=0.593, oof_coverage=74.67%
...
- MODEL_EDGE: AMBER — prob=0.9699, acc=0.3363, auc=0.5926, models=xgb-cpu
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=96.17%, acc=46.02%, auc=0.761, oof_coverage=74.83%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=727, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=4515674580800.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0447
- MODEL_EDGE: AMBER — prob=0.9617, acc=0.4602, auc=0.7609, models=xgb-cpu
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=88.55%, acc=40.71%, auc=0.672, oof_coverage=74.67%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=727, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=224680495525.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0396
- MODEL_EDGE: AMBER — prob=0.8855, acc=0.4071, auc=0.6725, models=xgb-cpu
- OOF_COVERAGE: PASS — coverage=74.67%, gap=20
...
- Model: prob=90.94%, acc=24.84%, auc=0.467, oof_coverage=74.45%
...
- MODEL_EDGE: AMBER — prob=0.9094, acc=0.2484, auc=0.4667, models=xgb-cpu
