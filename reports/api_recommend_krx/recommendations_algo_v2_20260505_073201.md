...
Generated: 2026-05-05T03:32:01+00:00
...
| 4 | 005380.KS | L | ACCUMULATE_RECOMMENDATION | 99.89 | 86.68% | 15.74 | 539000.00 | 474320.00 | 646800.00 | 1.67 | 0.50% | 12.00% | 0.01 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
...
- Model: prob=91.08%, acc=46.02%, auc=0.685, oof_coverage=74.51%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=728, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=224680495525.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0396
- MODEL_EDGE: AMBER — prob=0.9108, acc=0.4602, auc=0.6846, models=logistic
- OOF_COVERAGE: PASS — coverage=74.51%, gap=20
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=83.51%, acc=47.79%, auc=0.821, oof_coverage=74.67%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=728, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=4515674580800.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0447
- MODEL_EDGE: AMBER — prob=0.8351, acc=0.4779, auc=0.8210, models=logistic
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=86.68%, acc=60.19%, auc=0.522, oof_coverage=75.00%
...
- MODEL_EDGE: PASS — prob=0.8668, acc=0.6019, auc=0.5217, models=logistic
