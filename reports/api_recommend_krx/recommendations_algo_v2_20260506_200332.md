...
Generated: 2026-05-06T16:03:32+00:00
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | 005380.KS | L | ACCUMULATE_RECOMMENDATION | 100.00 | 86.99% | 15.84 | 539000.00 | 474320.00 | 646800.00 | 1.67 | 0.50% | 12.00% | 0.01 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
...
| 3 | 005490.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 93.36% | 9.00 | 502000.00 | 476900.00 | 552200.00 | 2.00 | 0.75% | 20.00% | 0.03 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 93.36%; 단기/중기 추세 확인 |
...
- Model: prob=86.99%, acc=60.78%, auc=0.659, oof_coverage=74.45%
...
- MODEL_EDGE: PASS — prob=0.8699, acc=0.6078, auc=0.6587, models=logistic
...
- Backtest: return=1.07%, Sharpe=0.335, Sortino=0.300, MDD=2.09%
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=100.00%, acc=48.67%, auc=0.647, oof_coverage=74.67%
...
- MODEL_EDGE: AMBER — prob=1.0000, acc=0.4867, auc=0.6472, models=logistic
...
- Backtest: return=0.39%, Sharpe=0.115, Sortino=0.085, MDD=3.25%
- Backtest honesty: AMBER (pass=4, amber=1, fail=0)
- Model: prob=93.36%, acc=46.02%, auc=0.686, oof_coverage=74.67%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=727, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=224680495525.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0396
- MODEL_EDGE: AMBER — prob=0.9336, acc=0.4602, auc=0.6864, models=logistic
- OOF_COVERAGE: PASS — coverage=74.67%, gap=20
- BACKTEST_SANITY: PASS — return=0.39%, sharpe=0.115, mdd=3.25%
- RISK_PLAN: PASS — stop_pct=5.00%, tp2_pct=10.00%, rr=2.00, risk_budget=0.75%
- TRACK_SCORE: PASS — score=100.00, green_threshold=75.00
- AUTOMATION_BOUNDARY: PASS — screening_output_only; broker_order_execution=False
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=83.43%, acc=48.08%, auc=0.821, oof_coverage=74.83%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=727, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=4515674580800.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0447
- MODEL_EDGE: AMBER — prob=0.8343, acc=0.4808, auc=0.8211, models=logistic
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=99.99%, acc=48.04%, auc=0.755, oof_coverage=74.45%
- Risk plan: stop=12.00%, tp2=20.00%, R/R=1.67, position_value=4166.67
- DATA_ROWS: PASS — rows=727, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=224680495525.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0396
- MODEL_EDGE: AMBER — prob=0.9999, acc=0.4804, auc=0.7551, models=logistic
- OOF_COVERAGE: PASS — coverage=74.45%, gap=63
