...
Generated: 2026-05-05T03:34:46+00:00
...
| 2 | 005490.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 91.08% | 8.66 | 502000.00 | 476900.00 | 552200.00 | 2.00 | 0.75% | 20.00% | 0.03 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 91.08%; 단기/중기 추세 확인 |
| 3 | 000660.KS | S | ELIGIBLE_RECOMMENDATION | 100.00 | 83.35% | 7.50 | 1447000.00 | 1374650.00 | 1591700.00 | 2.00 | 0.75% | 20.00% | 0.01 | 8/9 | data_source=yfinance; cv_gap=20; 모델 상승확률 83.35%; 단기/중기 추세 확인 |
| 4 | 005380.KS | L | ACCUMULATE_RECOMMENDATION | 99.81 | 86.97% | 15.83 | 539000.00 | 474320.00 | 646800.00 | 1.67 | 0.50% | 12.00% | 0.01 | 9/9 | data_source=yfinance; cv_gap=63; 장기 추세 구조 양호; 52주 고점 대비 과열이 아닌 조정권 |
...
- Backtest: return=1.13%, Sharpe=0.354, Sortino=0.314, MDD=2.09%
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=100.00%, acc=48.38%, auc=0.647, oof_coverage=74.51%
...
- MODEL_EDGE: AMBER — prob=1.0000, acc=0.4838, auc=0.6466, models=logistic
- OOF_COVERAGE: PASS — coverage=74.51%, gap=20
- BACKTEST_SANITY: PASS — return=1.13%, sharpe=0.354, mdd=2.09%
...
- Model: prob=91.08%, acc=46.31%, auc=0.685, oof_coverage=74.51%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=728, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=224680495525.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0396
- MODEL_EDGE: AMBER — prob=0.9108, acc=0.4631, auc=0.6846, models=logistic
- OOF_COVERAGE: PASS — coverage=74.51%, gap=20
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=83.35%, acc=47.79%, auc=0.820, oof_coverage=74.67%
- Risk plan: stop=5.00%, tp2=10.00%, R/R=2.00, position_value=15000.00
- DATA_ROWS: PASS — rows=728, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=4515674580800.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0447
- MODEL_EDGE: AMBER — prob=0.8335, acc=0.4779, auc=0.8204, models=logistic
...
- Backtest: return=1.02%, Sharpe=0.531, Sortino=0.719, MDD=1.10%
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=86.97%, acc=59.87%, auc=0.518, oof_coverage=75.00%
...
- MODEL_EDGE: PASS — prob=0.8697, acc=0.5987, auc=0.5183, models=logistic
- OOF_COVERAGE: PASS — coverage=75.00%, gap=63
- BACKTEST_SANITY: PASS — return=1.02%, sharpe=0.531, mdd=1.10%
...
- Backtest honesty: PASS (pass=5, amber=0, fail=0)
- Model: prob=99.99%, acc=48.54%, auc=0.755, oof_coverage=75.00%
- Risk plan: stop=12.00%, tp2=20.00%, R/R=1.67, position_value=4166.67
- DATA_ROWS: PASS — rows=728, min_rows=260
- LIQUIDITY: PASS — avg_dollar_volume_20d=224680495525.00
- MARKET_REGIME: PASS — regime_score=100.00, atr_pct=0.0396
- MODEL_EDGE: AMBER — prob=0.9999, acc=0.4854, auc=0.7553, models=logistic
- OOF_COVERAGE: PASS — coverage=75.00%, gap=63
