...
Generated: 2026-05-03T11:26:20+00:00
...
Data provider: fdr | Synthetic flag: False
Audit log: reports\full_verify_fdr_after_patch\audit_log.jsonl

| Rank | Ticker | Track | Verdict | Score | Prob | EV% | Entry | Stop | TP2 | R/R | Risk% | MaxPos% | Qty | Confirms | Evidence |
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | AAPL | S | ELIGIBLE_RECOMMENDATION | 87.65 | 46.25% | 2.48 | 280.14 | 268.93 | 308.15 | 2.50 | 0.75% | 20.00% | 66.93 | 8/9 | data_source=FinanceDataReader; cv_gap=20; 단기/중기 추세 확인; 백테스트 MDD 2.03% |
